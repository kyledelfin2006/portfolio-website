...
- Dark mode uses the primary acid accent for the professional subtitle and project names while project descriptions return to warm-white ink; light mode keeps its restrained hierarchy.
- Desktop and 320px browser review covered the project list and case-study header in dark and light themes with no clipping, horizontal overflow, or browser errors. Print maps stack text to black.
...
| Project description | `#f1eee4` | `#425f00` | `#000000` |
| Stack green | `#6db33f` / `rgb(109, 179, 63)` | `#3f6f24` | `#000000` |
